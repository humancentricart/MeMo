...
def create_large_sample(save_dir, dataset_name, n_sample=3*(10**4)):
    ...
    # data_path = '/home/giancarlo/hf_cache/datasets/wikipedia/20220301.en/2.0.0/d41137e149b2ea90eead07e7e3f805119a8c22dd1d5b61651af8e3e3ee736001'
    # data = Dataset.from_file(data_path).select_columns('text')
    data = load_dataset('wikipedia', '20200501.en').select_columns('text')
...
def create_all_datasets(main_data_dir):
    ...
    samples_data_dir = os.path.join(main_data_dir, 'scaling') #'sets')
    ...
    for num_samples in [100, 200, 300]: #[20, 100]:#[1000, 3000, 10000, 20000, 30000]:
